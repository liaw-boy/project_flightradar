...
const lastStoredPoint = new Map(); // [Track Dedup] icao24 -> { lat, lng, altitude, heading, velocity, ts } — [MEM-LEAK 2026-09] had no cleanup of its own; now reaped alongside activeSessions in server.js's session-timeout reaper
