...
const translations = {
    en: {
        ...
        statsEngine: 'Engine',
        statsTotal: 'Total',
        statsAirborne: 'Airborne',
        statsGround: 'Ground',
        statsEmergency: 'Emergency',
        statsAvgAlt: 'Avg Altitude',
        statsFastest: 'Fastest',
        statsUniqueAirlines: 'Unique Airlines',
        statsTypes: 'Aircraft Types',
